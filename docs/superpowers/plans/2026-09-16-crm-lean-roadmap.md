...
| AI Assistant V1A | **ACTIVE**（当前实现切片 = PR B — Read Runtime；PR A MERGED AND VERIFIED） | 只读 Ask / Analyze | 0.4–0.7× |
...
**AI Assistant V1A = ACTIVE**（当前实现切片 = PR B — Read Runtime；PR A — AI Foundation MERGED AND VERIFIED）；**AI Assistant V1B = PLANNED**。不要开始 PR C / AI Workspace UI。完成 Hardening 本身不自动 Promote AI。
...
→ AI Assistant V1A             ACTIVE（当前实现切片 = PR B — Read Runtime；PR A MERGED AND VERIFIED）
