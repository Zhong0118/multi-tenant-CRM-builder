...
| AI Assistant V1A | **ACTIVE**（当前实现切片 = PR C — AI Workspace UI + Closeout；PR A/B MERGED AND VERIFIED） | 只读 Ask / Analyze | 0.4–0.7× |
...
**AI Assistant V1A = ACTIVE**（当前实现切片 = PR C — AI Workspace UI + Closeout；PR A/B MERGED AND VERIFIED）。完成仍须等 PR C merge + post-merge 六门 + 浏览器 walkthrough。**AI Assistant V1B = PLANNED**。完成 Hardening 本身不自动 Promote AI。
...
→ AI Assistant V1A             ACTIVE（当前实现切片 = PR C — AI Workspace UI + Closeout；PR A/B MERGED AND VERIFIED）
