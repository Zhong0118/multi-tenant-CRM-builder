...
- 管理工作台：商机总数 16、预计金额可见。初查「跟单商机」「成交金额」QUERY_FAILED（F-02）。本地 seed reconcile 填上 filterFields 后复测：跟单商机 **10**、成交金额 **¥244,500**，失败文案消失。代码修复在 `fix/demo-dashboard-filter-fields`（PR #20），尚未合 main。
