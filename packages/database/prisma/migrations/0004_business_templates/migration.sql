...
CREATE POLICY "business_template_versions_platform_admin_access" ON "business_template_versions"
TO crm_app
USING (
  EXISTS (
    SELECT 1
...
CREATE POLICY "business_template_applications_platform_admin_access" ON "business_template_applications"
TO crm_app
USING (
  EXISTS (
    SELECT 1
